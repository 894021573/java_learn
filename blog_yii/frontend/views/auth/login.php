<main class="r_box">
    <form action="index.php?r=auth/do-login" method="post" name="saypl" id="saypl" onsubmit="return CheckPl(document.saypl)">
        <div id="plpost">
            ...
            <p><input name="imageField" type="submit" value="登录" style="float: left"></p>
